...
export namespace Prisma {
  ...
  */
  ...
  export type FormOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "userId" | "createdAt" | "published" | "name" | "description" | "content" | "visits" | "submissions" | "shareURL", ExtArgs["result"]["form"]>
  ...
  export interface Prisma__FormClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    ...
    FormSubmission<T extends Form$FormSubmissionArgs<ExtArgs> = {}>(args?: Subset<T, Form$FormSubmissionArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$FormSubmissionPayload<ExtArgs>, T, "findMany", GlobalOmitOptions> | Null>
    /**
  ...
  export type FormSubmissionOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "createdAt" | "formId" | "content", ExtArgs["result"]["formSubmission"]>
